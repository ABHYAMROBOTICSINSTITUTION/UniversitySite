...
const testimonials = [
  {
    ...
    message:
      "The university's learning environment is top-notch. The faculty and facilities have helped me grow beyond my expectations.",
    image: "/person1.jpg",
    rating: 5,
  },
  {
    ...
    message:
      "Practical labs, experienced professors, and a vibrant campus life – everything you’d want from a university!",
    image: "/person2.jpg",
    rating: 4,
  },
  {
    ...
    message:
      "From quality education to career support, this university has truly shaped my future. Highly recommended!",
    image: "/person3.jpg",
    rating: 3,
  },
];
